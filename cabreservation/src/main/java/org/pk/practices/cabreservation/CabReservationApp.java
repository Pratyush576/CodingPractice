...
public class CabReservationApp {
    ...
    public static void main(String[] args) {
        ...
        TripService tripService = new TripService(tripRepository, driverService, eventBus);
        ...
        Javalin app = Javalin.create(config -> {
            ...
            // cabreservation/src/main/resources/public/{index.html,style.css,app.js}
        ...
        new DriverController(driverService, matchingEngine, tripService, riderRepository, driverRepository).register(app);
        new TripController(tripService, riderRepository, driverRepository).register(app);
